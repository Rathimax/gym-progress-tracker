...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const setupEventListeners = () => {
        const toggleMenu = () => { elements.sidebar.classList.toggle('active'); elements.navOverlay.classList.toggle('active'); };
        elements.hamburgerBtn.addEventListener('click', toggleMenu); elements.closeNavBtn.addEventListener('click', toggleMenu); elements.navOverlay.addEventListener('click', toggleMenu);
        ...
        elements.toggleInputBtn.addEventListener('click', () => { isCustomInput = !isCustomInput; elements.toggleInputBtn.classList.toggle('active'); 
